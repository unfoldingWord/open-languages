    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          variant="outline"
          size="sm"
          className="h-8 border-dashed text-black"
        >
      ...
      <PopoverContent className="w-[200px] bg-white p-0" align="start">
        <Command>
          ...
          <CommandList>
            <CommandEmpty className="flex items-center justify-center py-5 text-black">
              No results found.
            </CommandEmpty>
            <CommandGroup>
              {options?.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    {option.icon && (
                      <option.icon className="text-muted-foreground mr-2 h-4 w-4 text-black" />
                    )}
